...
| Column Name          | Data Type     | Description                                             |
| -------------------- | ------------- | ------------------------------------------------------- |
| product\_key         | VARCHAR(42)   | Surrogate key uniquely identifying each product record. |
...
| reserved\_inventory    | INT          | Reserved stock quantity.                  |
| unreserved\_inventory  | INT          | Available stock not reserved.             |
...
| store\_product\_key    | VARCHAR(42)  | Surrogate key for store-product record.   |
| dq\_record\_status     | VARCHAR(10)  | Data quality flag (Valid / Invalid).      |
...
| store\_location\_id  | VARCHAR(10)  | Natural identifier for the store location.            |
| store\_address       | VARCHAR(255) | Store address.                                        |
| store\_city          | VARCHAR(50)  | Store city.                                           |
| store\_country       | VARCHAR(50)  | Store country.                                        |
| store\_postcode      | VARCHAR(20)  | Store postal code.                                    |
...
| Column Name          | Data Type     | Description                                               |
| -------------------- | ------------- | --------------------------------------------------------- |
| sales\_person\_key   | VARCHAR(42)   | Surrogate key (sales\_person\_id + store\_id).            |
| sales\_person\_id    | VARCHAR(10)   | Natural identifier for the sales person.                  |
| store\_location\_id  | VARCHAR(10)   | Identifier of store where sales person works.             |
...
| Column Name               | Data Type     | Description                                                |
| ------------------------- | ------------- | ---------------------------------------------------------- |
| sales\_order\_key         | VARCHAR(42)   | Surrogate key (order\_id + product\_id + store\_id).       |
...
| order\_number             | VARCHAR(20)   | External order number.                                     |
...
| Column Name          | Data Type    | Description                                               |
| -------------------- | ------------ | --------------------------------------------------------- |
| ship\_order\_key     | VARCHAR(42)  | Surrogate key (order\_id + ship\_id + product\_id).       |
